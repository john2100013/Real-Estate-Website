...
if(isset($_POST['insert']))
{
	...
	if(!empty($state) && !empty($city)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>County/City Inserted Successfully</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>* City/County Not Inserted</p>";
			}
	}
	else{
...
<head>
        ...
        <title>Unity Homes- Data Tables</title>
            ...
            <div class="page-wrapper">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">Add City/Town</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post" id="insert product" enctype="multipart/form-data">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<h5 class="card-title">City/Town Details</h5>
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">City/Town Name</label>
														<div class="col-lg-9">
				...
				<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">City/Town List</h4>
