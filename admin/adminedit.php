...
if(isset($_POST['update']))
{
	...
	$sql="UPDATE admin SET status = '{$status}' WHERE aid = {$aid}";
										...
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="aid" value="<?php echo $row['0']; ?>" disabled>
													</div>
												</div>
												<div class="form-group row">
