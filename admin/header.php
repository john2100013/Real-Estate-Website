  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/unity-homes.png" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/unity-homes.png" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown app-dropdown">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="assets/img/profiles/admin1.png" width="31" alt="Ryan Taylor"></span>
						</a>
						
						<div class="dropdown-menu">
							<div class="user-header">
								<div class="avatar avatar-sm">
									<img src="assets/img/profiles/admin1.png" alt="User Image" class="avatar-img rounded-circle">
								</div>
								<div class="user-text">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>County & Town</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php"> County </a></li>
									<li><a href="cityadd.php"> Town </a></li>
								</ul>
							</li>
