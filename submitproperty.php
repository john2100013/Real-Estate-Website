									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="1st Floor">Ground Floor Only</option>
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">City/Town</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="city" required placeholder="Enter City/Town">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
															<option value="">Select Floor</option>
															<option value="1st Floor">Ground Floor</option>
