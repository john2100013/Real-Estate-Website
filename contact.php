...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row">
                    <div class="col-lg-4 mb-5 bg-secondary">
                        <div class="contact-info">
                            <h3 class="mb-4 mt-4 text-white">Unity Homes Contacts</h3>
							
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Address</h5>
                                        <span class="text-white">Tatu City,Ruiru,Kenya</span> <br>
										<span class="text-white">Tatu City,Ruiru,Kenya</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">CALL UNITY HOMES ON</h5>
                                        <span class="d-table text-white">+254111564164</span>
										<span class="text-white">+254743410254</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">2005184@students.kcau.ac.ke</span>
										<span class="text-white">2005184@students.kcau.ac.ke</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d3989.028791620551!2d36.90737811409061!3d-1.1398617991685585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e4!4m0!4m5!1s0x182f39efdcb6f491%3A0x635a391a7a6a364f!2sUnity%20West%2C%20Tatu%20City!3m2!1d-1.1398625!2d36.9095667!5e0!3m2!1sen!2ske!4v1678039790065!5m2!1sen!2ske" width="1500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
